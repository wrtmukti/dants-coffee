...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::get('/table/create', [App\Http\Controllers\AdminController::class, 'createTable']);
    Route::post('/table', [App\Http\Controllers\AdminController::class, 'storeTable']);
    Route::put('/table/{id}', [App\Http\Controllers\AdminController::class, 'updateTable']);

    Route::get('/order/dinein', [App\Http\Controllers\OrderController::class, 'dinein']);
    Route::get('/order/takeaway', [App\Http\Controllers\OrderController::class, 'takeaway']);
    Route::get('/order/dinein/{id}', [App\Http\Controllers\OrderController::class, 'dineinShow']);
    Route::get('/order/takeaway/{id}', [App\Http\Controllers\OrderController::class, 'takeawayShow']);
    Route::get('/order/reservation', [App\Http\Controllers\OrderController::class, 'reservation']);
    Route::get('/order/reservation/{id}', [App\Http\Controllers\OrderController::class, 'reservationShow']);
    ...
    Route::get('/transaction/invoice/{id}', [App\Http\Controllers\TransactionController::class, 'invoice']);
